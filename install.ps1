...
# All rights reserved.
#
# Installation script for the doftiles thats include `Oh My Posh` a prompt
# theme engine.  This installer is only available for PowerShell on Windows
# system.  This installation script is still work in progress and subject to
# change.  I still need to think about this repository code, and now this is
# a base code.
...
# This file has been automatically generated by `mdsanima-power` installation
# script file by typing on the terminal this `.\install.ps1` file script.
# For more information about this configuration code, please check the event
# logs below, or contact the developer in Amarokelab organization.
...
function Write-ShowHelp {
    Write-ShowVersion
    Write-Host "  This installer is only available for PowerShell on Windows system." -ForegroundColor White
    Write-Host ""
    Write-Host "  Copyright (c) 2024-2025 Marcin Różewski, Amarokelab. All rights reserved." -ForegroundColor Blue
    Write-Host ""
}
...
function Out-CreateProfile {
    ...
    if (Test-Path -Path $profilePath) {
        ...
        Write-ShowInfo Green DarkGray "The backup for profile has been successfully created in the 'PowerShell' directory."
    ...
    Write-ShowInfo Green DarkGray "The new profile has been successfully created in the 'PowerShell' directory."
...
if ($install -like $true) {
    ...
    Write-ShowInfo Blue White "Setting up a execution polic ..."
