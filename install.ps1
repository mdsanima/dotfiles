...
# This is a installation script for `Oh My Posh` a prompt theme engine.  This installer is only
# available for PowerShell terminal on Windows system.  The installation script is still work in
# progress.
...
# This file has been automatically generated by `mdsanima-power` installation script file by typing
# on the terminal this `.\install.ps1` file script.  For more information, please check the event
# logs below, or contact MDSANIMA DEV orgs.
...
function Write-ShowHelp {
    Write-ShowVersion
    Write-Host "  This installer is only available for PowerShell terminal on Windows system." -ForegroundColor White
    Write-Host ""
